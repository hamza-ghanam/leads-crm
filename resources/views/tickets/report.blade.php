                ...
                <form role="form" id="filter-form" method="post" action="">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-sm-2">
                                <select id="fstatus" name="fstatus" class="form-control form-control-sm select2">
                                    ...
                                    @foreach($statuses as $status)
                                        ...
                                        @endif
                                        <option
                                            {{($currentStatus == $status->slug) ? 'selected' : ''}} value="{{$status->slug}}">{{$status->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-sm-2">
                                <select id="sales" name="sales" class="form-control form-control-sm select2">
                                    ...
                                    @foreach($sales as $sale)
                                        <option
                                            {{($currentSale == $sale->id) ? 'selected' : ''}} value="{{$sale->id}}">{{$sale->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            @endhasanyrole
                        ...
                        <div class="form-group row">
                            ...
                            <label for="from" class="col-sm-1 col-form-label-sm">From:</label>
                            <div class="col-sm-3">
                                <input type="date" class="form-control form-control-sm" name="updated_from"
                                       id="updated-from"
                                       value="{{ $updatedFrom }}"/>
                            </div>
                            <label for="to" class="col-sm-1 col-form-label-sm">To:</label>
                            <div class="col-sm-3">
                                <input type="date" class="form-control form-control-sm" name="updated_to"
                                       id="updated-to"
                                       value="{{ $updatedTo }}"/>
                            </div>
                        </div>
